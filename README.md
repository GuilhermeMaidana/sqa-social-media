...
`ci.yml` roda em pull requests para a branch `main`. Ele executa:

- testes e build da API;
- testes do frontend.

`e2e.yml` roda em pull requests para a branch `main`, e também pode ser acionado manualmente. Ele prepara MySQL, Java, Node.js e Playwright, sobe API e frontend no runner e executa os testes da pasta `e2e/`. Ao final, publica o relatório HTML do Playwright como artifact quando disponível.
